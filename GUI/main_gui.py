...
def launch_gui():
    """Launch the GUI."""
    global entry_swc_name, entry_directory, predefined_settings_var
    global label_solver, entry_solver, label_time_step, entry_time_step, label_coder_format, entry_coder_format
    ...
    combo_subcomponents.set(1)  # Default value
    ...
    combo_units.set(1)  # Default value
